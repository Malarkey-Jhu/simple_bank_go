...
func TestTransferTx(t *testing.T) {
	...
	for i := 0; i < n; i++ {
		...
		fmt.Println("---during tx:", fromAccount.Balance, toAccount.Balance)
		...
		// k should be 1 ~ n, since there are n concurrent transactions
		k := int(diff1 / amount)
		require.True(t, k >= 1 && k <= n)
		require.NotContains(t, exisited, k)
		exisited[k] = true
	}
